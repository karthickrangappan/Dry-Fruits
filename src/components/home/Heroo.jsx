        ...
        <section className="bg-white ">
            <div className="max-w-7xl mx-auto">
                <div className="relative rounded-[3rem] overflow-hidden group ">
                    <div className="relative z-20 flex flex-col md:flex-row items-center justify-between p-8 md:p-16 gap-12 bg-white">
                        <div className="max-w-2xl text-center md:text-left flex-1">
                            <h4 className="text-amber-600 font-black uppercase tracking-[0.4em] text-xs mb-6 inline-block px-4 py-2 border border-amber-600/20 rounded-full bg-amber-50">
                                Fresh Arrival
                            </h4>
                            <h2 className="text-5xl md:text-7xl font-black text-stone-900 mb-8 leading-tight tracking-tighter">
                                Organic <br />
                                <span className="text-amber-600 italic font-serif">Selection</span> <br />
                                <span className="text-stone-900">Boost Your Health</span>
                            </h2>
                            <p className="text-stone-500 font-black text-lg mb-10 leading-relaxed max-w-xl italic">
                            ...
                            <div className="flex flex-wrap justify-center md:justify-start gap-5">
                                <button
                                    ...
                                    className="px-10 py-4 bg-amber-600 text-white font-black rounded-2xl shadow-xl shadow-amber-600/30 hover:bg-amber-700 hover:scale-105 active:scale-95 transition-all duration-300 transform"
                                >
                                    View All Collection
                                </button>
                            </div>
